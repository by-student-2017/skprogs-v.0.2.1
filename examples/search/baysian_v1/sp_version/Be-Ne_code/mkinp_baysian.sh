...
awk -v n1st_dftbatom=${n1st_dftbatom} '{
  ...
  else if(NR==n1st_dftbatom+4){printf "        P = PowerCompression { Power = sigma_p; Radius = r0_p }\n"}
  else if(NR==n1st_dftbatom+5){printf "        S = PowerCompression { Power = sigma_s; Radius = r0_s }\n"}
  else {print $0}
