...
print("initial parameters:   x0  x1  x2  x3  x4  x5  x6  x8   x9"
  +"  x10  x7  x11  x12  x13")
print("initial parameters: ",x0,x1,x2,x3,x4,x5,x6,x8,x9,x10,x7,x11,x12,x13)
#x = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16] # spd
x = [x0,x1,x2,x3,x4,x5,x6,x8,x9,x10,x7,x11,x12,x13]
#------------------------------------------------

#------------------------------------------------
n_gene = 14 # number of parameters, number of individual +1
...
subprocess.run("echo \"#| iter | 1/target | x0 | x1 | x2 | x3 | x4 | x5 | x6 | x7 | x8 |"
  +" x9 | x10 | x11 | x12 | x13 | SDT | SDT(3kbT) |\" >> Evalute.txt", shell=True)
#------------------------------------------------
...
def descripter(x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13): # sp
  ...
  subprocess.run("echo No."+str(count)+": "+str(etav)
    ...
    +", "+sx2+", "+sx3 # S orbital
    +", "+sx4+", "+sx5 # P orbital
    +", "+sx6+", "+sx8+", "+sx9+", "+sx10   # Slater-Type Orbitals of S
    +", "+sx7+", "+sx11+", "+sx12+", "+sx13 # Slater-Type Orbitals of P
