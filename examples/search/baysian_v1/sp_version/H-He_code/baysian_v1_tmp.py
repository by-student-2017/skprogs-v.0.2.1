...
print("initial parameters:   x0  x1  x2  x3  x6  x8  x9")
print("initial parameters: ",x0,x1,x2,x3,x6,x8,x9)
#x = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16] # spd
x = [x0,x1,x2,x3,x6,x8,x9]
#------------------------------------------------

#------------------------------------------------
n_gene = 10 # number of parameters, number of individual +1
...
subprocess.run("echo \"#| iter | 1/target | x0 | x1 | x2 | x3 | x6 | x8 | x9 | SDT | SDT(3kbT) |\" >> Evalute.txt", shell=True)
#------------------------------------------------
...
def descripter(x0,x1,x2,x3,x6,x8,x9): # s
