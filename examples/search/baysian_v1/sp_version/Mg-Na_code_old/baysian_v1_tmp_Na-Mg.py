...
print("initial parameters:   x0  x1  x2  x3  x4  x5   x8   x9"
  +"  x10  x11  x12  x13")
print("initial parameters: ",x0,x1,x2,x3,x4,x5,x8,x9,x10,x11,x12,x13)
#x = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16] # spd
x = [x0,x1,x2,x3,x4,x5,x8,x9,x10,x11,x12,x13]
#------------------------------------------------

x6=x7=x14=x15=x16=1.0 # dummy
#------------------------------------------------
...
def descripter(x0,x1,x2,x3,x4,x5,x8,x9,x10,x11,x12,x13):
