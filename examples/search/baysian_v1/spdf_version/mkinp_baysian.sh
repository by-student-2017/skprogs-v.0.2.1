...
awk -v n1st_dftbatom=${n1st_dftbatom} '{
  ...
  else if(NR==n1st_dftbatom+4){printf "        F = PowerCompression { Power = sigma_f; Radius = r0_f }\n"}
  else if(NR==n1st_dftbatom+5){printf "        D = PowerCompression { Power = sigma_d; Radius = r0_d }\n"}
  else if(NR==n1st_dftbatom+6){printf "        P = PowerCompression { Power = sigma_p; Radius = r0_p }\n"}
  else if(NR==n1st_dftbatom+7){printf "        S = PowerCompression { Power = sigma_s; Radius = r0_s }\n"}
  else {print $0}
...
x2=`awk -v n1st_dftbatom=${n1st_dftbatom} '{
  ...
  else if(NR==n1st_dftbatom+7 && $1=="S" && $5=="="){printf "%4.1f",$6}
  else if(NR==n1st_dftbatom+7 && $1=="S" && $6=="="){printf "%4.1f",$7}
}' ${filename}`
...
x4=`awk -v n1st_dftbatom=${n1st_dftbatom} '{
  ...
  else if(NR==n1st_dftbatom+7 && $1=="P" && $5=="="){printf "%4.1f",$6}
  else if(NR==n1st_dftbatom+7 && $1=="P" && $6=="="){printf "%4.1f",$7}
}' ${filename}`
x5=`awk -v n1st_dftbatom=${n1st_dftbatom} '{
  ...
  else if(NR==n1st_dftbatom+7 && $1=="P" &&  $9=="="){printf "%4.1f",$10}
  else if(NR==n1st_dftbatom+7 && $1=="P" && $10=="="){printf "%4.1f",$11}
}' ${filename}`
#----------
x6=`awk -v n1st_dftbatom=${n1st_dftbatom} '{
  ...
  else if(NR==n1st_dftbatom+7 && $1=="D" && $5=="="){printf "%4.1f",$6}
  else if(NR==n1st_dftbatom+7 && $1=="D" && $6=="="){printf "%4.1f",$7}
}' ${filename}`
x7=`awk -v n1st_dftbatom=${n1st_dftbatom} '{
  ...
  else if(NR==n1st_dftbatom+7 && $1=="D" &&  $9=="="){printf "%4.1f",$10}
  else if(NR==n1st_dftbatom+7 && $1=="D" && $10=="="){printf "%4.1f",$11}
}' ${filename}`
#----------
x23=`awk -v n1st_dftbatom=${n1st_dftbatom} '{
       if(NR==n1st_dftbatom+4 && $1=="F" && $5=="="){printf "%4.1f",$6}
  else if(NR==n1st_dftbatom+4 && $1=="F" && $6=="="){printf "%4.1f",$7}
  else if(NR==n1st_dftbatom+5 && $1=="F" && $5=="="){printf "%4.1f",$6}
  else if(NR==n1st_dftbatom+5 && $1=="F" && $6=="="){printf "%4.1f",$7}
  else if(NR==n1st_dftbatom+6 && $1=="F" && $5=="="){printf "%4.1f",$6}
  else if(NR==n1st_dftbatom+6 && $1=="F" && $6=="="){printf "%4.1f",$7}
  else if(NR==n1st_dftbatom+7 && $1=="F" && $5=="="){printf "%4.1f",$6}
  else if(NR==n1st_dftbatom+7 && $1=="F" && $6=="="){printf "%4.1f",$7}
}' ${filename}`
x24=`awk -v n1st_dftbatom=${n1st_dftbatom} '{
       if(NR==n1st_dftbatom+4 && $1=="F" &&  $9=="="){printf "%4.1f",$10}
  else if(NR==n1st_dftbatom+4 && $1=="F" && $10=="="){printf "%4.1f",$11}
  else if(NR==n1st_dftbatom+5 && $1=="F" &&  $9=="="){printf "%4.1f",$10}
  else if(NR==n1st_dftbatom+5 && $1=="F" && $10=="="){printf "%4.1f",$11}
  else if(NR==n1st_dftbatom+6 && $1=="F" &&  $9=="="){printf "%4.1f",$10}
  else if(NR==n1st_dftbatom+6 && $1=="F" && $10=="="){printf "%4.1f",$11}
  else if(NR==n1st_dftbatom+7 && $1=="F" &&  $9=="="){printf "%4.1f",$10}
  else if(NR==n1st_dftbatom+7 && $1=="F" && $10=="="){printf "%4.1f",$11}
}' ${filename}`
#----------
...
sed -i "s/x23_Zz/${x23}/g" baysian_v1_$1.py
...
awk -v n2nd=${n2nd} '{
  ...
  else if(NR==n2nd+7){printf "    F = stof \n"}
  else {print $0}
...
#----------
y0s=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="S"){printf "%4.2f",$3} }' ${filename}`
y0p=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="P"){printf "%4.2f",$3} }' ${filename}`
y0d=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="D"){printf "%4.2f",$3} }' ${filename}`
y0f=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="F"){printf "%4.2f",$3} }' ${filename}`
#----------
ylasts=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="S"){printf "%6.2f",$7} }' ${filename}`
ylastp=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="P"){printf "%6.2f",$7} }' ${filename}`
ylastd=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="D"){printf "%6.2f",$7} }' ${filename}`
ylastf=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="F"){printf "%6.2f",$7} }' ${filename}`
#----------
sed -i "s/y0s_Nn/${y0s}/g" baysian_v1_$1.py
sed -i "s/y0p_Nn/${y0p}/g" baysian_v1_$1.py
sed -i "s/y0d_Nn/${y0d}/g" baysian_v1_$1.py
sed -i "s/y0f_Nn/${y0f}/g" baysian_v1_$1.py
#----------
...
sed -i "s/ylastf_Nn/${ylastf}/g" baysian_v1_$1.py
#----------
x8=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="S"){printf "%4.2f",$4} }' ${filename}`
x9=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="S"){printf "%4.2f",$5} }' ${filename}`
x10=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="S"){printf "%4.2f",$6} }' ${filename}`
x25=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="S"){printf "%4.2f",$8} }' ${filename}`
#----------
sed -i "s/x8_Nn/${x8}/g" baysian_v1_$1.py
sed -i "s/x9_Nn/${x9}/g" baysian_v1_$1.py
sed -i "s/x10_Nn/${x10}/g" baysian_v1_$1.py
sed -i "s/x25_Nn/${x25}/g" baysian_v1_$1.py
#----------
x11=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="P"){printf "%4.2f",$4} }' ${filename}`
x12=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="P"){printf "%4.2f",$5} }' ${filename}`
x13=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="P"){printf "%4.2f",$6} }' ${filename}`
x26=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="P"){printf "%4.2f",$8} }' ${filename}`
#----------
sed -i "s/x11_Nn/${x11}/g" baysian_v1_$1.py
sed -i "s/x12_Nn/${x12}/g" baysian_v1_$1.py
sed -i "s/x13_Nn/${x13}/g" baysian_v1_$1.py
sed -i "s/x26_Nn/${x26}/g" baysian_v1_$1.py
#----------
x14=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="D"){printf "%4.2f",$4} }' ${filename}`
x15=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="D"){printf "%4.2f",$5} }' ${filename}`
x16=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="D"){printf "%4.2f",$6} }' ${filename}`
x27=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="D"){printf "%4.2f",$8} }' ${filename}`
#----------
sed -i "s/x14_Nn/${x14}/g" baysian_v1_$1.py
sed -i "s/x15_Nn/${x15}/g" baysian_v1_$1.py
sed -i "s/x16_Nn/${x16}/g" baysian_v1_$1.py
sed -i "s/x27_Nn/${x27}/g" baysian_v1_$1.py
#----------
x29=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="F"){printf "%4.2f",$4} }' ${filename}`
x30=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="F"){printf "%4.2f",$5} }' ${filename}`
x31=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="F"){printf "%4.2f",$6} }' ${filename}`
x33=`awk -v n2nd=${n2nd} '{ if((n2nd+4)<=NR && NR<=(n2nd+7) && $1=="F"){printf "%4.2f",$8} }' ${filename}`
#----------
sed -i "s/x29_Nn/${x29}/g" baysian_v1_$1.py
sed -i "s/x30_Nn/${x30}/g" baysian_v1_$1.py
sed -i "s/x31_Nn/${x31}/g" baysian_v1_$1.py
sed -i "s/x33_Nn/${x33}/g" baysian_v1_$1.py
#----------
#-----------------------------------------------------------------------------------
