...
sed   "s/element_Xx/$1/g" ${python_filename} > pso_v1_$1.py
atomic_number=`awk -v n1st=${n1st} '{if(NR==n1st+2){printf "%4.1f",$3}}' ${filename}`
sed -i "s/atomic_number_Yy/${atomic_number}/g" pso_v1_$1.py
...
}' ${filename} > skdef.hsd.tmp_pso_1st
...
#----------
sed -i "s/x0_Zz/${x0}/g" pso_v1_$1.py
sed -i "s/x1_Zz/${x1}/g" pso_v1_$1.py
sed -i "s/x2_Zz/${x2}/g" pso_v1_$1.py
sed -i "s/x3_Zz/${x3}/g" pso_v1_$1.py
sed -i "s/x4_Zz/${x4}/g" pso_v1_$1.py
sed -i "s/x5_Zz/${x5}/g" pso_v1_$1.py
sed -i "s/x6_Zz/${x6}/g" pso_v1_$1.py
sed -i "s/x7_Zz/${x7}/g" pso_v1_$1.py
#----------
#-----------------------------------------------------------------------------------
n2nd=`grep $1 -n skdef.hsd.tmp_pso_1st | sed "s/:.*//g" | sed -n "2p"`
#echo ${n2nd}
...
}' skdef.hsd.tmp_pso_1st > skdef.hsd.tmp_pso_$1
sed -i "s/skdef.hsd.tmp_pso/skdef.hsd.tmp_pso_$1/g" pso_v1_$1.py
...
#----------
sed -i "s/y0s_Nn/${y0s}/g" pso_v1_$1.py
sed -i "s/y0p_Nn/${y0p}/g" pso_v1_$1.py
sed -i "s/y0d_Nn/${y0d}/g" pso_v1_$1.py
#----------
sed -i "s/ylasts_Nn/${ylasts}/g" pso_v1_$1.py
sed -i "s/ylastp_Nn/${ylastp}/g" pso_v1_$1.py
sed -i "s/ylastd_Nn/${ylastd}/g" pso_v1_$1.py
#----------
...
#----------
sed -i "s/x8_Nn/${x8}/g" pso_v1_$1.py
sed -i "s/x9_Nn/${x9}/g" pso_v1_$1.py
sed -i "s/x10_Nn/${x10}/g" pso_v1_$1.py
#----------
...
#----------
sed -i "s/x11_Nn/${x11}/g" pso_v1_$1.py
sed -i "s/x12_Nn/${x12}/g" pso_v1_$1.py
sed -i "s/x13_Nn/${x13}/g" pso_v1_$1.py
#----------
...
#----------
sed -i "s/x14_Nn/${x14}/g" pso_v1_$1.py
sed -i "s/x15_Nn/${x15}/g" pso_v1_$1.py
sed -i "s/x16_Nn/${x16}/g" pso_v1_$1.py
#----------
#-----------------------------------------------------------------------------------
rm -f skdef.hsd.tmp_pso_1st
rm -f ${filename}
#-----------------------------------------------------------------------------------
python3 pso_v1_$1.py
#-----------------------------------------------------------------------------------
