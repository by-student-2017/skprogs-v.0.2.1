...
element = "Mn"
#------------------------
stospt = np.array([1.0,1.03,1.06,1.09,1.11])
stodt  = np.array([1.0,1.03,1.06,1.09,1.11])
#------------------------
stosp  = np.array([2.0,2.5,3.5,5.0,7.0])
stod   = np.array([2.5,3.5,5.0,7.0,9.5])
#------------------------
...
#----------------------------------------------------------------------
# fitting parameters
for dt in np.arange(13.0,65.0,1.0):
  for spt in np.arange(17.0,65.0,0.2):
