...
Just to be sure, for elements with atomic numbers 13 to 56, we searched for parameters with the initial values of sigma at density set to 2.7, 5, 7, 9, and 12. In that case, the initial value of r0 was set to reflect the inverse proportionality trend seen in Boron and Mn.
