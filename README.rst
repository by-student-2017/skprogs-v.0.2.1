...
- As a first step in material search, it is conceivable to search for a structure using DFTB+ or Lammps to satisfy an "e/uc" (many reports have been made by U. Mizutani and H. Sato et al. for the "e/uc". [7]). This "e/uc" has been investigated using real material structures from the Pearson Handbook and verified by the non-spin scheme. Therefore, it is estimated that these can play an active role even Slater-Koster parameters and potentials by the non-spin scheme. One of the reasons why material exploration using "e/uc" is not currently being carried out is that the Slater-Koster parameters and classical MD potentials are not available for all of the elemental pairs. I am strongly convinced that the results of this research will be valuable basic research for realizing materials exploration using "e/uc."
