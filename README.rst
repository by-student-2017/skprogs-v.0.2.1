...
In papers, sigma values of 2, 4, and 6 are selected, and parameter optimization using genetic algorithms (GA) reports sigma values close to 7 for many constituent elements of LiCoO2.
