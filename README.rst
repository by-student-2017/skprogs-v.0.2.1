...
Although it is not mentioned much in the paper, experimentally the interatomic distance is the sum of the covalent bond radii of the paired elements (A and B) (Rcov(AB)=rcov(A)+rcov(B) ) is known to be. Therefore, for the unitary system (A and A), it is natural that r0, which is related to potential confinement, is twice rcov.
