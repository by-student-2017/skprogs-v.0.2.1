...
- https://github.com/by-student-2017/DFTBP (Using DFTB+ on Lammps DFTBP allows you to take advantage of the useful features of Lammps (I have not yet confirmed whether the GCMC method is also available).)
