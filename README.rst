...
- Although we are currently investigating, there is a similar trend regarding simga parameters. In B, as the simga is increased from 2.0, the s-band approaches the DFT result.
