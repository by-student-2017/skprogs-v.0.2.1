...
- Although some conditions are different from the paper [1], r0 of "QUASINANO" gives good results. There is a similar trend regarding simga parameters. The simga is increased from 2.0, the s-band approaches the DFT result.
