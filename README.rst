...
- As a first step in material search, it is conceivable to use DFTB+ or Lammps to search for a structure that satisfies e/uc, which has been widely reported by U. Mizutani and H. Sato et al. [7]. This e/uc has been investigated using real material systems from the Pearson Handbook and verified non-spin. Therefore, it is estimated that it can be used sufficiently even with the non-spin Slater-Koster parameter and potential. One of the reasons why there is currently no material exploration using e/uc is that the parameters and potential are not available. I am strongly convinced that the results of this research will be valuable basic research for realizing materials exploration using e/uc.
