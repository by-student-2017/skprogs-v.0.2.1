...
This result is contradicted by the fact that sigma values of 2, 4, and 6 are selected in papers, and that sigma values of many constituent elements for LiCoO2 using genetic algorithm (GA) are reported to be close to 7. I have not.
